...
class UserInput():
    ...
    def getNum(self, userText : str) -> int:
        num = -1
        for i in userText:
            try:
                num = int(i)
...
ans = ModelResponse("Hello, can you help me with my tasks?").generateOutput()
print("LISA:",ans)
...
if __name__ == "__main__":
    ...
    while True:
        print("You : ", end="")
        if sunn:
            user_input = get_input()    # For Voice Input
        else:
            user_input = get_input2()   # For Text Input
        ...
        if user_input is None:
            ...
            continue
        elif user_input.lower() == "hindi":
            language = 'hi'
            speak("Language changed to Hindi")
            continue
        elif user_input.lower() == "text mode":
            sunn = False
            ...
            ans = ModelResponse().generateOutput(user_input)   # This is Model to generate Output...
